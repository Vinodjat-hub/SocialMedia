package com.socialmedia.runner;
	...
	public void run(String... args) throws Exception {
		...
		if (users == null || users.isEmpty()) {
			Users user1 = Users.builder().email("vinodjat8818@gmail.com").isDeleted(false)
					.password(passwordEncoder.encode("vinod@123")).name("Vinod Jat").status("ACTIVE")
					.bio("I am the Admin").isDeleted(false).role(Role.ADMIN).build();
